    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li><a href="projects_view.php?x=sas">Overview <span class="sr-only">(current)</span></a></li>
                <li><a href="projects_view.php">Reports</a></li>
                <li><a href="projects_view.php">Analytics</a></li>
                <li><a href="projects_view.php">Export</a></li>
            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Dashboard</h1>
            <?php
                $lists = $parser->svn_list->children();
            ?>
